...
<body> 
  ...
  <div id="content" style="padding-top:80px">
     <div id="wrap">
      ...
      <div class="news" class="col-sm-12">
  ...
  <div id="single" class="carousel slide" data-ride="carousel" data-shift="1" class="col-xs-12">
    <div id="single-quad" class="carousel slide" data-ride="carousel" data-shift="1">
      ...
      <a class="carousel-control left" href="#single-quad" data-slide="next"></a>
      <a class="carousel-control right" href="#single-quad" data-slide="prev"> </a>
    </div>
  </div>
</div>
</div>
