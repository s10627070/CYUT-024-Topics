		...
		<div class="content">
			<div class="container">
                ...
                <div class="col-xs-12 col-sm-4" style="margin-top:30px">
                  <div align="center" id ="row"  style="font-size:20px; border-radius: 3px; border: 8px solid #fff; margin: 15px; -webkit-box-shadow: 0 0 3px 3px #ebebeb; box-shadow: 0 0 3px 3px #ebebeb;">
                    <input type="hidden" id="id" value="<?php echo $row['id'];?>">
                    <input type="hidden" id="end_time" value="<?php echo $row['end_time'];?>">
                    <img src='<?php echo $row['image_path']; ?>' width="280" height="210" class="rounded">
