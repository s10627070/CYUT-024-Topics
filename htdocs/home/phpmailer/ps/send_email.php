...
//SELECT id , username , mail , password , name FROM user WHERE mail = 'ms880525@gmail.com'
...
?> 
<script type="text/javascript">alert("查無此信箱，請重新輸入!");window.location.href="forget.php";</script> 
<?php  
exit; 
}
else{ 
