...
<html lang="zh-TW">
  <head>
    ...
    <script>function refresh_code(){document.getElementById("imgcode").src="../confirm/captcha.php";}</script>
  </head>
  ...
  <body>
          ...
          <div class="col-xs-12 col-sm-4 col-sm-offset-4">
            ...
            <form class="login">
              ...
              <div class="form-group">
                ...
                <p><img id="imgcode" src="../confirm/captcha.php" onclick="refresh_code()" />&nbsp;&nbsp;&nbsp;&nbsp;點擊圖片可以更換驗證碼
              </div>
    ...
    <script>
      ...
      $(document).on("ready", function() {
            ...
            {
              //註冊新增成功，轉跳到登入頁面。
             window.location.href = "../admin/index.php"; //因為目前的 login.php 跟後端的 index.php 首頁在同一資料夾，所以直接叫他就好
            }
            else
            {
