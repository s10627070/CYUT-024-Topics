          ...
          <div class="col-xs-12">
            <form id="add_bidding_form">
              ...
              <div class="form-group">
                ...
                <input type="input" class="form-control" id="year">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="input" class="form-control" id="now_price">
              </div>
              <div class="form-group">
                <label for="tobuy">直購價</label>
                <input type="input" class="form-control" id="tobuy">
              </div>
              <div class="form-group">
    ...
    <script>
    	$(document).on("ready", function(){
          ...
          $("a.del_image").on("click", function() {
            ...
            //表單送出
    		$("#add_bidding_form").on("submit", function(){
    			//加入loading icon
    			$("div.loading").html('<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i>');
    			
    			if($("#name").val() == '' || $("#image_path").val() == '' || $("#price").val() == '' || $("#now_price").val() == '' || $("#end_time").val() == ''){
    				alert("請填入所有表格");
    				...
    				$("div.loading").html('');
		              ...
		              $.ajax({
                    type : "POST",
                    url : "../php/add_bidding.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
                    data : {
                      name : $("#name").val(),
