...
*/
    ...
    try {
        ...
        //基本參數(請依系統規劃自行調整)
        $obj->Send['ReturnURL']         = "https://sean19981002.ddns.net/Ecpay/payEcpay.php" ;
        //$obj->Send['ReturnURL']         = "https://mountain101.ddns.net/home/Ecpay/payEcpay.php" ;    //付款完成通知回傳的網址
        $obj->Send['MerchantTradeNo']   = '12313132123';                                  //訂單編號
        $obj->Send['MerchantTradeDate'] = date('Y/m/d H:i:s');                       //交易時間
        $obj->Send['TotalAmount']       = '222';                                      //交易金額
        $obj->Send['TradeDesc']         = "無人旅館" ;                                   //交易描述
        ...
        /*foreach($_SESSION["item"] as $row){
        array_push($obj->Send['Items'], $row );
        unset($_SESSION["item"]);  
        unset($_SESSION['shopping_cart']);
        }*/
        //訂單的商品資料
        array_push($obj->Send['Items'], array('Name' => $aroom, 'Price' => (int)$totalprice,
